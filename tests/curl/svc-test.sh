...
curl -X POST -H "Content-Type: application/x-www-form-urlencoded" -H "Authorization: Bearer $ACCESS_TOKEN" "http://${SERVICES_HOST}:${SERVICES_PORT}/carts?id=jahong&productId=Test-Product-2&quantity=0"
